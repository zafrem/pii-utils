module github.com/zafrem/pii-utils/grep-cloud-storage
...
// so we point it at the git submodule checked out at the repository root.
replace pii_verification => ../pii-pattern-engine/verification/golang
